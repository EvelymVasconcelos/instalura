...
export default function Text({
  ...
  return (
    <TextBase
            // como nosso TextBase está definido como span, passamos "as"
            // que vai fazer com que a tag seja recebida como foi passada para o component
      as={tag}
      variant={variant}
            // isso significa que o componente Text pode receber qualquer
            // props que for enviada, ou seja, um spread de props
